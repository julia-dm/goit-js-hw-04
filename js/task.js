...
//   ({ rating }) => rating > MIN_RATING || rating === MIN_RATING
// );
...
//   users.filter(({ eyeColor }) => eyeColor === color).map(users => users.name);
...
// isEveryUserActive = users.every(({ isActive }) => isActive === true);
// console.log(isEveryUserActive, users);
// const players = {
//   mango: 1270,
//   poly: 468,
...
// const totalAveragePlaytimePerGame = players.reduce((avg, player) => {
//   return (avg += player.playtime / player.gamesPlayed);
// }, 0);
...
//   },
// ];
// const calculateTotalBalance = users.reduce((total, client) => {
...
const students = [
  {
    name: 'Mango',
    score: 83,
    courses: ['mathematics', 'physics', 'mathematics'],
  },
  { name: 'Poly', score: 59, courses: ['science', 'mathematics'] },
  { name: 'Ajax', score: 37, courses: ['physics'] },
];

const sortedByAscendingScore = students.toSorted(
